...
pub fn logout() -> Result<()> {
    ...
    if path.exists() {
        fs::remove_file(&path)?;
        println!("{} {}", console::style("✓").green().bold(), console::style("Logged out of Envoy.").green());
    } else {
        println!("{} {}", console::style("ℹ").cyan(), console::style("Already logged out.").cyan());
    }
